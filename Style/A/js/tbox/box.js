...
jQuery.extend(ui.box, {
    ...
    init:function(option){
		...
		$('#tsbox').show();
		if($.browser.msie){$(".boxy-wrapper").css({'top':'0px'});
    }
		//$('#tsbox').css({
    ...
    _viewport: function() {
        ...
        return jQuery.extend(
            jQuery.browser.msie ?
                { left: b.scrollLeft || d.scrollLeft, top: b.scrollTop+80 || d.scrollTop } :
    ...
    _u: function() {
	 ...
	 _cssForOverlay: function() {
        if (ui.box.IE6) {
            ...
            return {width: '100%', height: jQuery(document).height()+150};
        }
    },
